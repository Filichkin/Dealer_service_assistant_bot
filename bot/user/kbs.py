...
def payments_kb() -> InlineKeyboardMarkup:
    kb = InlineKeyboardBuilder()
    kb.button(text='🧾 Детали платежей', callback_data='payments_details')
    kb.button(text='🏠 На главную', callback_data='home')
    kb.adjust(1)
    return kb.as_markup()
...
def get_service_buy_kb(price) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text='✖️ Отменить', callback_data='home')]
    ])
...
def cancel_kb_inline() -> InlineKeyboardMarkup:
    kb = InlineKeyboardBuilder()
    kb.button(text='✖️ Выйти', callback_data='cancel_service')
    return kb.as_markup()
...
def cancel_search_kb_inline() -> InlineKeyboardMarkup:
    kb = InlineKeyboardBuilder()
    kb.button(text='⚙️ Parts', callback_data='parts_service')
    kb.button(text='✖️ Выйти', callback_data='cancel_service')
    return kb.as_markup()
